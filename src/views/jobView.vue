...
onMounted(async ()=>{
    ...
    console.log(state.job.company.name);
        ...
        console.error('Job not loading', error);
    }finally{
        isLoading : false
    }
});
...
const deleteJob = async () =>{
  ...
  try{
    ...
    alert('Job Deleted ...!');
        ...
        console.error('Job not deleting', error);
    }
}
          ...
          <aside>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <RouterLink
                ...
                >Edit Job</RouterLink>
              <RouterLink @click="deleteJob" to="/jobs"
                class="bg-red-500 hover:bg-red-600 text-white font-bold text-center py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
              >
                Delete Job
              </RouterLink>
            </div>
